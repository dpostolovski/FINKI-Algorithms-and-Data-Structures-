...
public class Preveduvac {
    public static void main (String[] args) throws IOException {
        ...
        for(int i =0; i < N;i++)
        {
            ...
            String zbor[] = line.split(" ");
            tabela.insert(new Zbor(zbor[1]), zbor[0]);
        }
        String zb = br.readLine();
        String prevod;

        while(!zb.equals("KRAJ"))
        {
            try {
                prevod = tabela.getBucket(tabela.search(new Zbor(zb))).value;
