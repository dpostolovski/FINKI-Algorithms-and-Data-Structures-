...
class DLL<E> {
    protected boolean swapCalled = false;
    ...
    public DLLNode<E> swap(DLLNode<E> node)
    {
        swapCalled = true;
...
public class BubbleSortDLL {
    ...
    public static void bubbleSort(DLL<Integer> lista){
        ...
        lista.swapCalled = true;

        while (lista.swapCalled) {
            lista.swapCalled = false;
            temp = lista.getFirst();
